...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="<?php echo base_url();?>">salamarathupatti</a> </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3 text-center">
        <div class="service-media"> <img src="<?php echo base_url();?>assets/img/services/service-1.jpg" alt=" "> </div>
      ...
      <div class="col-md-3 text-center">
        <div class="service-media"> <img src="<?php echo base_url();?>assets/img/services/service-2.jpg" alt=" "> </div>
        <div class="service-desc">
      ...
      <div class="col-md-3 text-center">
        <div class="service-media"> <img src="<?php echo base_url();?>assets/img/services/service-3.jpg" alt=" "> </div>
        <div class="service-desc">
          <h3>Tree Care</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sed dapibus leo nec ornare diam sedasd commodo nibh ante facilisis bibendum dolor feugiat at.</p>
        </div>
      ...
      <div class="col-md-3 text-center">
        <div class="service-media"> <img src="<?php echo base_url();?>assets/img/services/service-4.jpg" alt=" "> </div>
        <div class="service-desc">
...
<div id="footer">
  <div class="container text-center">
    <div class="col-md-8 col-md-offset-2">
      ...
      <p>&copy; 2021 salamarathupatti. Designed by <a href="https://www.instagram.com/mr.kirubhaa/" rel="nofollow">kirubha</a></p>
    </div>
  </div>
</div>
